<template>
  <AtDropdown
    ...
    content-classes="bg-white w-full"
    :closable="false"
  >
    <template #trigger>
      <div class="date-select">
        ...
        >
          ...
          <div
            class="flex w-full ml-1 space-x-2 text-sm text-left"
            v-if="date && showTimeResult"
          >
            <span>at</span>
            <span
              class="w-20 px-1 font-bold hover:border- hover:bg-gray-50 bg-blend-lighten hover:bg-blend-darken"
              >{{ humanTime }}</span
            >
          </div>
        </button>
