<template>
  <section class="flex w-full auth-fluid">
    <section
      class="w-4/12 h-screen auth-cover"
      :style="{ 'background-image': coverImage }"
    ></section>
    <section
      class="flex flex-col items-center justify-center w-8/12 h-screen"
      ref="loginBox"
    >
      <main class="z-10 w-full px-12 py-4 login-box__form" :class="boxClass">
        <slot></slot>
      </main>
    </section>
  </section>
